...
function Kavo.CreateLib(kavName, themeList)
    ...
    Main.Size = UDim2.new(0, 525, 0, 515)
    ...
    blurFrame.Size = UDim2.new(1, 0, 0, Main.AbsoluteSize.Y-36)
    ...
    MainSide.Position = UDim2.new(0, 0, 0, MainHeader.AbsoluteSize.Y)
    MainSide.Size = UDim2.new(0, 149, 0, Main.AbsoluteSize.Y-MainHeader.AbsoluteSize.Y)
    ...
    pages.Position = UDim2.new(0.299, 0, 0, MainHeader.AbsoluteSize.Y+6)
    pages.Size = UDim2.new(0, 360, 0, Main.AbsoluteSize.Y-(MainHeader.AbsoluteSize.Y+6))
    ...
    infoContainer.Position = UDim2.new(0.299047619, 0, 0, Main.AbsoluteSize.Y-36)
