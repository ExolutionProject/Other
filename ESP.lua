...
local win = SolarisLib:New({
  Name = "Any Game Script by dontab",
  FolderToSave = "SolarisLibStuff"
})

local tab = win:Tab("Fast scripts")
local tab2 = win:Tab("Main Scripts")


local sec1 = tab:Section("Movement")
local sec2 = tab:Section("Other")

local sec22 = tab2:Section("Main Scripts")


sec1:Button("Inffinity Jumping", function()
 game:GetService("UserInputService").JumpRequest:connect(function()
        game:GetService"Players".LocalPlayer.Character:FindFirstChildOfClass'Humanoid':ChangeState("Jumping")        
    end)    
end)

sec2:Button("CtrlClick TP", function()
...
sec2:Button("Alt+Click Delete", function()
...
SolarisLib:Notification("Binds", "Bind AimBot: MouseRightClick")
...
sec22:Bind("Bind ESP", Enum.KeyCode.F, false, "BindNormal", function()
    
end)



sec22:Button("Esp", function()
    SolarisLib:Notification("Binds", "Bind ESP: L")
